...
enum parameters {FIRSTPARAM_UNKNOW,SCONDPARAM_UNKNOW,THRDPARAM_UNKNOW};
...
class mesh{
    ...
    public:
        void setParameters(float unknow_A,float unknow_E, float unknow_F){
            parameters[FIRSTPARAM_UNKNOW] = unknow_A;
            parameters[SCONDPARAM_UNKNOW] = unknow_E;
            parameters[THRDPARAM_UNKNOW] = unknow_F;
